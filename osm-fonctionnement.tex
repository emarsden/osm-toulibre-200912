...
\frame { \heading{Collecte des données}
  ...
  \bigskip
  \raisebox{-0.6em}{\Huge\color{red}\Stopsign{}} Interdiction d'utiliser les cartes propriétaires!
}
...
\frame { \heading{Rendu de la carte}
  ...
  \begin{itemize}
  \item Se fait automatiquement une fois que les données sont transférées vers le serveur
