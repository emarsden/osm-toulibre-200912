...
\frame{\includegraphics[width=0.95\textwidth,clip,trim=0cm 2cm 0cm 4cm]{figures/toulouse-carmes}}
...
\item[\raisebox{-0.4em}{\ecmfrownie}] Les principales sources de données aujourd'hui sont non-libres: IGN, INSEE,
  NavTec, Spot Image
\end{itemize}

\begin{itemize}
\item[\raisebox{-0.4em}{\ecmfrownie}] Avec Google Maps, je peux calculer un itinéraire pour circuler en
